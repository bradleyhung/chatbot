  ...
  // work per element
      ...
      <section id="sorting-algorithms" className="mb-8">
        ...
        <p className="text-gray-700 mb-2">
          ...
          HeapSort (O(n log n)), Bubble/Insertion (O(n^2)). Choose by stability,
          memory, average/worst-case, and simplicity.
        </p>
        <div className="bg-gray-50 p-4 rounded border">
      ...
      <section id="hash-tables" className="mb-8">
        ...
        <p className="text-gray-700 mb-2">
          Hash tables map keys to buckets via a hash function. Average access is
          O(1); collision resolution affects performance (chaining, open
          addressing). Good for fast lookups and frequency counting.
        </p>
        <div className="bg-gray-50 p-4 rounded border">
          <strong>Collision handling</strong>
          <p className="text-sm mt-2">
            Chaining stores a list per bucket; open addressing probes to find an
            empty slot. Choose based on memory and clustering behavior.
          </p>
        </div>
      </section>
    </main>
